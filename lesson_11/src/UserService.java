...
//                signInComplete(userArrayList, newUser);
                ...
                do {
                    ...
                    switch (option){
                        case 1:
                            checkNewUserName(userArrayList, newUser);
                            break;
                        case 2:
                            checkNewEmail(userArrayList, newUser);
                            break;
                        case 3:
                            checkNewPassword( newUser);
                            break;
                        case 4:
...
//                        forgetPass(newUser);
                        ...
                        do {
                            ...
                            if(newUser.getEmail().equals(fEmail)){
                                checkNewPassword(newUser);// nhập mk mới
                                flagForgetPass = false;
                            } else {
                                System.out.println("Không tồn tại tài khoản.");
                            }
                        }while (flagForgetPass);
                        check = false;
                        break;
                    case 3:
                        check = false;
